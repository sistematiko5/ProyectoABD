...
<html>
  ...
  <body>
      ...
      <div class="row"> <!--Row titulo-->
        <div>
          <p>TodoPerros te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web www.starton.es.
      ...
      <div class="row"> <!--Row titulo-->
        <div>
          ...
          <p>Para navegar por TodoPerros no es necesario que facilites ningún dato personal.</p>
        </div>
      </div>
  </div>
</body>
